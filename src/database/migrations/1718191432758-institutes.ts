...
export class Institutes1718191432758 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            INSERT INTO institutes (id, name, short_name, number) VALUES
            (1, 'Институт аэрокосмических приборов и систем', 'Институт 1', 1),
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            DELETE FROM institutes WHERE id IN (1, 2, 3, 4, 5, 6, 7, 8, 9);
        `);
  }
}
